...
export default function CreateUser({userId, onClose, onSave, onEdit}) {
console.log(userId)
    const [user, setUser ] = useState({});
    useEffect(() => {
        if (!userId) return;
        UserService.getOneUser(userId).then((user) => {setUser(user)})
    }, [userId]);

    console.log("Ne Stava", userId, user)
    return (
                    ...
                    <header className="headers">
                        ...
                        <button className="btn close">
                            <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="xmark"
                                 ...
                                 viewBox="0 0 320 512" onClick={onClose}>
                    ...
                    <form onSubmit={userId ? onEdit : onSave}>
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-group" style={{display: "none"}}>
                                ...
                                <div className="input-wrapper">
                                    <span><i className="fa-solid fa-house-chimney"></i></span>
                                    <input id="createdAt" name="createdAt" type="text" defaultValue={user.createdAt}/>
                                </div>
                            </div>

                        </div>
                        <div id="form-actions">
                            <button id="action-save" className="btn" type="submit" >{userId ? "Edit" : "Save"}</button>
