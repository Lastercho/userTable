...
export default function UserInfo({userIdInfo, onClose}) {
    const [user, setUser] = useState({});
    useEffect(() => {
        userService.getOneUser(userIdInfo).then((user) => {setUser(user)})
    }, [userIdInfo]);
    return (
                ...
                <div className="detail-container">
                    ...
                    <div className="content">
                        ...
                        <div className="user-details">
                            ...
                            <p>Created on: <strong>{dateTimeUtils(user.createdAt)}</strong></p>
                            <p>Modified on: <strong>{dateTimeUtils(user.updatedAt)}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
